Sample_Name = "bNTI_Feat_OTU_Synoptic_WLE_transition_allsites_FTICR_100" # Input sample name
Factor = "transect"
Level = "transition"
...
feat.by.samp<- read.csv("bNTI_Feat_OTU_Synoptic_WLE_transition_allsites_FTICR_100_bNTI_feature_by_samp_transect-transition_100rep.csv", row.names=1)
...
p4
ggsave("bnti_wle_transition_all_sites_fticr_100perm_06.05.25_labels_ggrepel.TIFF", plot=p4, dpi=300, height=10, width=20, units=c("in"))
...
ggsave("bnti_wle_transition_all_sites_fticr_100perm_03.13.26_labels_ggrepel.TIFF", plot=p4, dpi=300, height=10, width=20, units=c("in"))
...
write.csv(feat.samp.frame.metadata, "feat.samp.frame.metadata.wle.transition.icr.csv")
write.csv(feat.samp.frame.metadata.tax, "feat.samp.frame.metadata.tax.wle.transition.icr.csv")
write.csv(feat.metadata.tax.mean.bnti, "feat.metadata.tax.mean.bnti.icr.wle.transition.csv")
...
write.csv(plot_summary_data, "plot_summary_data_icr_wle_transition.csv")
...
ggsave("bnti_wle_transition_all_sites_fticr_100perm_03.13.26_points.TIFF", plot=bnti_plot, dpi=300, height=5, width=6, units=c("in"))
