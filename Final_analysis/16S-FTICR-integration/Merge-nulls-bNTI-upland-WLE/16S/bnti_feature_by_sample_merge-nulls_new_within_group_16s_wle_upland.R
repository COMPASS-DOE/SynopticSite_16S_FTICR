Sample_Name = "bNTI_16S_OTU_Synoptic_WLE_upland_allsites_16S_100" # Input sample name
Factor = "transect"
Level = "upland"
...
feat.by.samp<- read.csv("bNTI_16S_OTU_Synoptic_WLE_upland_allsites_16S_100_bNTI_feature_by_samp_transect-upland_100rep.csv", row.names=1)
...
specified_labels <- c("e3620a87443a142150a1b20a237c48a2", "120eba657e42a11a5c29f97b90f02035")
label_replacements <- data.frame(
  original_label = specified_labels,
  display_label = c("Rhizobiales", "Streptomycetales")
)
...
specified_labels <- c("e3620a87443a142150a1b20a237c48a2", "120eba657e42a11a5c29f97b90f02035")
highlight_labels <- c("Rhizobiales", "Streptomycetales")
...
ggsave("bnti_wle_upland_all_sites_16s_100perm_06.05.25_labels_ggrepel.TIFF", plot=p4, dpi=300, height=10, width=20, units=c("in"))
...
ggsave("bnti_wle_upland_all_sites_16s_100perm_03.12.26_labels_ggrepel.TIFF", plot=p4, dpi=300, height=10, width=20, units=c("in"))
...
write.csv(feat.samp.frame.metadata, "feat.samp.frame.metadata.wle.upland.csv")
write.csv(feat.samp.frame.metadata.tax, "feat.samp.frame.metadata.tax.wle.upland.csv")
write.csv(feat.metadata.tax.mean.bnti, "feat.metadata.tax.mean.bnti.wle.upland.csv")



##keep only the orders in the network 
feat.metadata.tax.mean.bnti.subset <- feat.metadata.tax.mean.bnti %>% filter(Order==c("o__Rhizobiales", "o__Streptomycetales"))
feat.metadata.tax.mean.bnti.subset

##i want to label the specific otus in the network
otus_to_label <- c("e3620a87443a142150a1b20a237c48a2", "120eba657e42a11a5c29f97b90f02035")
...
write.csv(plot_summary_data, "plot_summary_data_16s_wle_upland.csv")
...
ggsave("bnti_wle_upland_all_sites_16s_100perm_03.12.26_points.TIFF", plot=bnti_plot, dpi=300, height=5, width=6, units=c("in"))
