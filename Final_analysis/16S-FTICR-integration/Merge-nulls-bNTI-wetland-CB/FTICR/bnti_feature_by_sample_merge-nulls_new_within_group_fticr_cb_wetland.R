Sample_Name = "bNTI_Feat_OTU_Synoptic_CB_wetland_allsites_FTICR_100" # Input sample name
Factor = "transect"
Level = "wetland"
...
feat.by.samp<- read.csv("bNTI_Feat_OTU_Synoptic_CB_wetland_allsites_FTICR_100_bNTI_feature_by_samp_transect-wetland_100rep.csv", row.names=1)
...
p4
ggsave("bnti_cb_wetland_all_sites_fticr_100perm_06.05.25_labels_ggrepel.TIFF", plot=p4, dpi=300, height=10, width=20, units=c("in"))
...
ggsave("bnti_cb_wetland_all_sites_fticr_100perm_03.13.26_labels_ggrepel.TIFF", plot=p4, dpi=300, height=10, width=20, units=c("in"))
...
write.csv(feat.samp.frame.metadata, "feat.samp.frame.metadata.cb.wetland.icr.csv")
write.csv(feat.samp.frame.metadata.tax, "feat.samp.frame.metadata.tax.cb.wetland.icr.csv")
write.csv(feat.metadata.tax.mean.bnti, "feat.metadata.tax.mean.bnti.icr.cb.wetland.csv")
...
write.csv(plot_summary_data, "plot_summary_data_16s_icr_wetland.csv")
...
ggsave("bnti_cb_wetland_all_sites_fticr_100perm_03.12.26_points.TIFF", plot=bnti_plot, dpi=300, height=5, width=6, units=c("in"))
