Sample_Name = "bNTI_16S_OTU_Synoptic_WLE_wetland_allsites_16S_100" # Input sample name
Factor = "transect"
Level = "wetland"
...
files = list.files(path = "transect-wetland/",
...
feat.by.samp<- read.csv("bNTI_16S_OTU_Synoptic_WLE_wetland_allsites_16S_100_bNTI_feature_by_samp_transect-wetland_100rep.csv", row.names=1)
...
specified_labels <- c("7a3120b453e96caf1a1e47ea48aa5f72",
                      "dec61e73164aaadc4fb9acdd960ea4bf",
                      "af062725e851baa19a57d27c454641e6",
                      "6bac3b034c95bc5c72bb06b8fb6e21a7",
                      "2a0a6367f794e66b396ec215ba393fc7",
                      "636920ddf9771ae64e909891454298bd",
                      "dd01c5e5904aa112d95ba6b2ccf5093b",
                      "c3b19ad8457af7b28d0b9c7eaaf1c0f7",
                      "ac3b3112d6f5ad7e40e570ccd1bb1efc",
                      "c9f9355d32e264f6bc060415332587bb",
                      "5143fb7763f5e216f42d16afa5a7312f",
                      "324792d80a7bdee8e81e5887b4504842",
                      "2fac845da336657d55f1a9f350c6bc09",
                      "75ea2daf1a41ca52cecdd1e27b663173",
                      "7cec74f1915964bc15aa37366183374f",
                      "50e5c97ca46d1b2cd105f7e13bb076fc",
                      "89df4eba23365b3a08d774a527d7a0bf",
                      "a27ceb0d07dcbd92593ffaf9ebfd024e",
                      "d20b46e3c9d79a8e49a48f112fc03d4f",
                      "26005dfb7ad2e8cdbb139846af329663",
                      "b72d2815103feb19f37f2521dac55754",
                      "b0546a8c6a38415c52d2dc916319d3fd",
                      "6d2033479b3f89b5ebf07b452ebdad8e",
                      "c6f96c0b79d9a6b82fb53a5518bce977",
                      "d829bee4984f82ffc2453212157caf96",
                      "7dbf8044196ea8cc894577991fee5afb")
label_replacements <- data.frame(
  original_label = specified_labels,
  display_label = c("PeM15",
                    "Anaerolineales",
                    "MB-A2-108",
                    "Solirubrobacterales",
                    "Pedosphaerales",
...
ggsave("bnti_wle_wetland_all_sites_16s_100perm_06.05.25_labels_ggrepel.TIFF", plot=p4, dpi=300, height=10, width=20, units=c("in"))
...
ggsave("bnti_wle_wetland_all_sites_16s_100perm_03.12.26_labels_ggrepel.TIFF", plot=p4, dpi=300, height=10, width=20, units=c("in"))
...
write.csv(feat.samp.frame.metadata, "feat.samp.frame.metadata.wle.wetland.csv")
write.csv(feat.samp.frame.metadata.tax, "feat.samp.frame.metadata.tax.wle.wetland.csv")
write.csv(feat.metadata.tax.mean.bnti, "feat.metadata.tax.mean.bnti.wle.wetland.csv")



##keep only the orders in the network 
feat.metadata.tax.mean.bnti.subset <- feat.metadata.tax.mean.bnti %>% filter(Order==c("o__PeM15",
                                                                                      "o__Anaerolineales",
                                                                                      "o__MB-A2-108",
                                                                                      ...
                                                                                      "o__Solirubrobacterales",
                                                                                      "o__Clostridiales",
                                                                                      "o__Peptostreptococcales-Tissierellales",
                                                                                      "o__Bacillales",
...
otus_to_label <- c("7a3120b453e96caf1a1e47ea48aa5f72",
                   "dec61e73164aaadc4fb9acdd960ea4bf",
                   "af062725e851baa19a57d27c454641e6",
                   "6bac3b034c95bc5c72bb06b8fb6e21a7",
                   "2a0a6367f794e66b396ec215ba393fc7",
...
plot_summary_data <- data_for_plotting_edit %>%
  ...
  summarize(
    ...
    # Add this line to grab the 'Order' value for the group
    Order = first(Order),
    #site = first(site),
...
write.csv(plot_summary_data, "plot_summary_data_16s_wle_wetland.csv")
...
ggsave("bnti_wle_wetland_all_sites_16s_100perm_03.13.26_points.TIFF", plot=bnti_plot, dpi=300, height=5, width=6, units=c("in"))
